...
Where to find freely available GPU and CPU computing resources for research on diseases like Alzheimers, Parkinsons, and ALS? This challenge faced by labs and researchers is becoming more acute with the increasing use of AI and machine learning (ML) which demand more computing capacity. For Dr. Priyanka Joshi’s [Biomolecular Homeostasis and Resilience Lab](https://www.joshilab.org/) at Georgetown University, the National Science Foundation (NSF) supported [OSPool](https://osg-htc.org/services/ospool/) and its HTCondor system was the answer.
...
After reading UW-Madison graduate and current [Morgridge Institute for Research](https://morgridge.org/) ML scientist [Sam Gelman’s](https://samgelman.com/#about) publication on [his research](https://www.biorxiv.org/content/10.1101/2024.03.15.585128v3.full) using publicly available [OSG resources](https://osg-htc.org/), Sherekar realized the OSPool would be a good fit for his own work. The OSPool, freely available  to researchers associated with a US institution, provides a much larger GPU infrastructure. Sherekar noted that “For those reasons, I think OSPool perfectly suits people who are in academia and who cannot get access to hardware resources easily.” Sherekar reached out to Gelman, who pointed him in the direction of the [Center for High Throughput Computing](https://chtc.cs.wisc.edu/) at UW-Madison, a partner with the [PATh](https://path-cc.io/) project that provides the services in support of the OSPool.
