...
<p><a href="https://vimeo.com/708267814">Black hole</a> from <a href="https://vimeo.com/morgridge">Morgridge Institute</a> on <a href="https://vimeo.com">Vimeo</a>.</p>
{: .text-center } _This video depicts all of the black hole simulations that were conducted using the Open Science Pool platform. A small number of these simulations are selected as “best bet models” that help validate the observed telescope data gathered by the Event Horizon project. Visualization credit: Ben Prather, University of Illinois at Urbana-Champaign. Image library credit: EHT Theory Working Group, CK Chan._ 
